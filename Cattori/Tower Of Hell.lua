...
local MainPage = Window:Server("Tower Of Hell", "")
...
MainTab:Toggle("Auto Farm", false, function(Enable)
    TOHSettings.Autofarm = Enable
end)

game:GetService("RunService").Heartbeat:Connect(function()
    if TOHSettings.Autofarm then
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace.tower.finishes:FindFirstChild("Finish").CFrame
    end
end)
